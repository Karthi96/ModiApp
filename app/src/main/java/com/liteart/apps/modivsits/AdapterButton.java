...
public class AdapterButton extends RecyclerView.Adapter<AdapterButton.MyViewHolder> {
    ...
    @Override
public AdapterButton.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {

    Context context = parent.getContext();
    LayoutInflater inflater = LayoutInflater.from(context);
    View photoView = inflater.inflate(R.layout.activity_cardview_button, parent, false);
   AdapterButton.MyViewHolder viewHolder = new AdapterButton.MyViewHolder(photoView);
    return viewHolder;
}

    @Override
    public void onBindViewHolder(AdapterButton.MyViewHolder holder, int position) {
    ...
    public AdapterButton(Context context, ArrayList<String> dataString) {
        mContext = context;
